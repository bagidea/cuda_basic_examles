...
ใน Example สุดท้าย ซึ่งก็คือ Ex4.cu จะเป็น Example ที่ใช้ประโยชน์จากเรื่อง GPU Parallel Programming มากที่สุด ซึ่งเป็นตัวอย่างการหาค่า min, max, และผลรวม จากชุดตัวเลขทั้งหมด 507,510,784 จำนวน  
